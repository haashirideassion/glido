...
export type Database = {
  public: {
    Tables: {
      ...
      cfs_shipments: {
        Row: { container_number: string | null; description: string | null; house_bill_number: string; id: string; imported_at: string; package_count: number | null; pallet_count: number | null; pallet_type: string | null; ready_for_collection: boolean; storage_start_date: string | null; tenant_id: string; volume_cbm: number | null; weight_kg: number | null }
        Insert: { container_number?: string | null; description?: string | null; house_bill_number: string; id?: string; imported_at?: string; package_count?: number | null; pallet_count?: number | null; pallet_type?: string | null; ready_for_collection?: boolean; storage_start_date?: string | null; tenant_id: string; volume_cbm?: number | null; weight_kg?: number | null }
        Update: { container_number?: string | null; description?: string | null; house_bill_number?: string; id?: string; imported_at?: string; package_count?: number | null; pallet_count?: number | null; pallet_type?: string | null; ready_for_collection?: boolean; storage_start_date?: string | null; tenant_id?: string; volume_cbm?: number | null; weight_kg?: number | null }
        Relationships: []
      }
      checkin_records: {
