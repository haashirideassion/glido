    ...
    <div style="display:flex; flex-direction:column; gap:10px; margin-bottom:28px;">
      ...
      <button type="button" x-on:click="$store.wizard.selectServiceType('pickup')"
        ...
        <div style="width:48px; height:48px; border-radius:12px; display:flex; align-items:center; justify-content:center; flex-shrink:0; border:1.5px solid #e5e7eb; transition:all 0.15s ease;"
          x-bind:style="{ background: $store.wizard.serviceType === 'pickup' ? '#FC6514' : '#f9fafb', borderColor: $store.wizard.serviceType === 'pickup' ? '#FC6514' : '#e5e7eb', color: $store.wizard.serviceType === 'pickup' ? '#fff' : '#9ca3af' }">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.2" style="stroke:currentColor;">
        ...
        <div style="width:20px; height:20px; border-radius:9999px; border:1.5px solid #e5e7eb; flex-shrink:0; display:flex; align-items:center; justify-content:center; transition:all 0.15s ease;"
          x-bind:style="{ background: $store.wizard.serviceType === 'pickup' ? '#FC6514' : 'transparent', borderColor: $store.wizard.serviceType === 'pickup' ? '#FC6514' : '#e5e7eb' }">
      ...
      <button type="button" x-on:click="$store.wizard.selectServiceType('dropoff')"
        ...
        <div style="width:48px; height:48px; border-radius:12px; display:flex; align-items:center; justify-content:center; flex-shrink:0; border:1.5px solid #e5e7eb; transition:all 0.15s ease;"
          x-bind:style="{ background: $store.wizard.serviceType === 'dropoff' ? '#FC6514' : '#f9fafb', borderColor: $store.wizard.serviceType === 'dropoff' ? '#FC6514' : '#e5e7eb', color: $store.wizard.serviceType === 'dropoff' ? '#fff' : '#9ca3af' }">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.2" style="stroke:currentColor;">
        ...
        <div style="width:20px; height:20px; border-radius:9999px; border:1.5px solid #e5e7eb; flex-shrink:0; display:flex; align-items:center; justify-content:center; transition:all 0.15s ease;"
          x-bind:style="{ background: $store.wizard.serviceType === 'dropoff' ? '#FC6514' : 'transparent', borderColor: $store.wizard.serviceType === 'dropoff' ? '#FC6514' : '#e5e7eb' }">
