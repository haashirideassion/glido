...
export const Step6ContactVehicle = () => (
  ...
  >
    <h2 style="font-size:18px; font-weight:700; color:#1C1917; letter-spacing:-0.03em; margin-bottom:3px;">Upload your Delivery Order</h2>
    ...
    <div
      x-show="$store.wizard.serviceType === 'dropoff'"
      style="margin-top:16px; background:rgba(0,0,0,0.025); border:1px solid rgba(0,0,0,0.08); border-radius:8px; padding:12px 16px; font-size:12px; color:#64748B; display:flex; align-items:flex-start; gap:10px; line-height:1.6;"
    >
